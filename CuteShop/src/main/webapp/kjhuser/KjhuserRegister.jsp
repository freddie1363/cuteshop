...
<%
 /**
  * @Class Name : KjhuserRegister.jsp
  * @Description : Kjhuser Register 화면
...
<c:set var="registerFlag" value="${empty kjhuserVO.id ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="kjhuserVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/kjhuser/KjhuserList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/kjhuser/deleteKjhuser.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/kjhuser/addKjhuser.do' : '/kjhuser/updateKjhuser.do'}"/>";
    frm.submit();
...
<form:form commandName="kjhuserVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
