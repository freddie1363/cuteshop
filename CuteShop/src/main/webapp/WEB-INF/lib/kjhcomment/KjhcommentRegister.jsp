...
<%
 /**
  * @Class Name : KjhcommentRegister.jsp
  * @Description : Kjhcomment Register 화면
...
<c:set var="registerFlag" value="${empty kjhcommentVO.cno ? '등록' : '수정'}"/>			
...
<!-- validator:javascript formName="kjhcommentVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/kjhcomment/KjhcommentList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/kjhcomment/deleteKjhcomment.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/kjhcomment/addKjhcomment.do' : '/kjhcomment/updateKjhcomment.do'}"/>";
    frm.submit();
...
<form:form commandName="kjhcommentVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
