...
<%
 /**
  * @Class Name : KjhgalleryList.jsp
  * @Description : Kjhgallery List 화면
...
function fn_egov_select(id) {
    document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/kjhgallery/updateKjhgalleryView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/kjhgallery/addKjhgalleryView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/kjhgallery/KjhgalleryList.do'/>";
   	document.getElementById("listForm").submit();
}
