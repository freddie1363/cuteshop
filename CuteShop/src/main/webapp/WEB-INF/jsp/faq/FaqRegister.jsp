...
<%
 /**
  * @Class Name : FaqRegister.jsp
  * @Description : Faq Register 화면
...
<c:set var="registerFlag" value="${empty faqVO.id ? '등록' : '수정'}"/>			
...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/faq/FaqList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/faq/deleteFaq.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/faq/addFaq.do' : '/faq/updateFaq.do'}"/>";
    frm.submit();
...
<form:form commandName="faqVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
