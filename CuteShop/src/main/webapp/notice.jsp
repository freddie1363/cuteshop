            ...
            <div id="gallerycontent" style="margin-left: 20px">
              ...
              <div id="centercontent">
                <ul style="margin-left: 20px">
                  ...
                  <li id="noticecontent">
                    <a href="/noticepost.jsp">
                      <span class="no">1</span
                      ><span class="subject">글쓰기 테스트중입니다.</span>
                      <span class="writer">테스트</span
                      ><span class="writedate">2022-05-23</span>
                    </a>
                  </li>
                  <li>
                    <span class="no" style="height: 50px"></span
                    ><span
                      class="subject"
                      style="
                        height: 50px;
                      ...
                      ><a href="">1</a></span
                    >
                    <span class="writedate" style="height: 50px"></span>
                    <span class="count" style="height: 50px"></span>
                  </li>
                  <li>
                    <span class="no" style="height: 50px"></span
                    ><span class="subject" style="height: 50px; width: 820px"
                      ><input
                        type="text"
                        style="
                          width: 600px;
                        ...
                        " />
                      <a href="" onclick="nextSemester();"
                        ><i class="fa-solid fa-magnifying-glass"></i></a
                    ></span>
                    <span class="writedate" style="height: 50px"></span>
                    <span class="count" style="height: 50px"
                      ><a href="" onclick="nextSemester();"
                        ><i class="fa-solid fa-pen"> 글쓰기</i></a
                      ></span
                    >
                  </li>
                </ul>
