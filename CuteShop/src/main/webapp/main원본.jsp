        ...
        <div class="main">
          ...
          <div class="section">
            <ul class="section1">
              ...
              <li class="article1">
                <div class="boardwrap" style="background-color: #99CCFF; color:white;">
                  <div style="margin-bottom: 35px;">
                    <span><a href="./notice.html" style="color: white;">GALLERY</a></span>
                    
                    <div style="padding-top: 15px;"><hr style="background-color:white;" /></div>
                  ...
                  <div>
                    ...
                    <button
                      ...
                      style="
                        ...
                        font-weight: bold;
                      "
                     onclick="location.href='/kjhgallery/KjhgalleryList.do'">
                     갤러리 이동 →
                    </button>
                  </div>
                </div>
