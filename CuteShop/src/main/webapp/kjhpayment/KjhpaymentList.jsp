...
<%
 /**
  * @Class Name : KjhpaymentList.jsp
  * @Description : Kjhpayment List 화면
...
function fn_egov_select(pno) {
    document.getElementById("listForm").pno.value = pno;
   	document.getElementById("listForm").action = "<c:url value='/kjhpayment/updateKjhpaymentView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/kjhpayment/addKjhpaymentView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/kjhpayment/KjhpaymentList.do'/>";
   	document.getElementById("listForm").submit();
}
